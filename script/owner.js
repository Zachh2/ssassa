...
module.exports.run = async function({ api, event, args, prefix, admin }) {
		...
		const CREATORLINK = "https://www.facebook.com/zachay.pnaveax";
		const BOTCREATOR = "zach";
		const BOTNAME = "AutoBot Inspired v5";
...
⁂ Bot Name: AutoBot by Zach
✧ Bot Admin: zach
♛ Bot Admin Link: https://www.facebook.com/zachay.pnaveax
❂ Bot Prefix: ${prefix}
